...
static struct PyModuleDef click_FatalImpl_moduledef = {
    PyModuleDef_HEAD_INIT,
    "click.FatalImpl",
    NULL,
    -1,
    click_FatalImpl_functions,
};
#endif
...
initclick_FatalImpl(void)
{
    PyObject *m;
    #if PY_VERSION_HEX >= 0x03000000
    m = PyModule_Create(&click_FatalImpl_moduledef);
    #else
...
static PyMethodDef click_Hash_Function_functions[] = {
    {NULL, NULL, 0, NULL}
};
/* --- classes --- */
...
#if PY_VERSION_HEX >= 0x03000000
static struct PyModuleDef click_Hash_Function_moduledef = {
    PyModuleDef_HEAD_INIT,
    "click.Hash.Function",
    NULL,
    -1,
    click_Hash_Function_functions,
};
#endif

static PyObject *
initclick_Hash_Function(void)
{
    PyObject *m;
    #if PY_VERSION_HEX >= 0x03000000
    m = PyModule_Create(&click_Hash_Function_moduledef);
    #else
    m = Py_InitModule3((char *) "click.Hash.Function", click_Hash_Function_functions, NULL);
    #endif
    if (m == NULL) {
        return NULL;
    }
...
static PyMethodDef click_Hash_functions[] = {
    {NULL, NULL, 0, NULL}
};
/* --- classes --- */
...
#if PY_VERSION_HEX >= 0x03000000
static struct PyModuleDef click_Hash_moduledef = {
    PyModuleDef_HEAD_INIT,
    "click.Hash",
    NULL,
    -1,
    click_Hash_functions,
};
#endif
...
initclick_Hash(void)
{
    ...
    PyObject *submodule;
    #if PY_VERSION_HEX >= 0x03000000
    m = PyModule_Create(&click_Hash_moduledef);
    #else
    m = Py_InitModule3((char *) "click.Hash", click_Hash_functions, NULL);
    #endif
    if (m == NULL) {
        return NULL;
    }
    ...
    submodule = initclick_Hash_Function();
    if (submodule == NULL) {
        return NULL;
    }
    Py_INCREF(submodule);
...
#if PY_VERSION_HEX >= 0x03000000
static struct PyModuleDef click_moduledef = {
    PyModuleDef_HEAD_INIT,
    "click",
    NULL,
    -1,
...
MOD_INIT(click)
{
    ...
    PyObject *submodule;
    #if PY_VERSION_HEX >= 0x03000000
    m = PyModule_Create(&click_moduledef);
    #else
